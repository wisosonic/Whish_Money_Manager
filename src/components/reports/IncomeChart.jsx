...
import { formatCompactMoney, formatMoney, sumChartData } from "@/lib/monthlyChartData";
  ...
  return (
    ...
    <div className="flex flex-wrap items-center justify-between gap-3 p-4 md:p-5 border-b">
      ...
      <div className="flex items-center gap-2 ms-auto">
        <label className="text-sm text-gray-600" htmlFor={yearId}>{t("chart.year")}</label>
        <select
          id={yearId}
          value={year}
    ...
    <div className="flex-1 overflow-auto p-2 md:p-4">
      {loading && !hasData ? (
        <div className="p-12 flex items-center justify-center gap-2 text-gray-500" data-testid="chart-loading">
